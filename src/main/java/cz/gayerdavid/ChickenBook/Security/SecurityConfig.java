...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .headers(headers -> headers.frameOptions(frame -> frame.disable())) // Allows correct view of h2 database in the web browser
                ...
                .addFilterBefore(new ExceptionHandlerFilter(), AuthenticationFilter.class) //First filter checking for exceptions
